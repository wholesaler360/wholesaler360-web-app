  ...
  (
    {
      ...
      iconPlacement,
      asChild = false,
      permissionModule, // Add new props for permission checking
      permissionAction,
      ...props
    },
    ref
    ...
    // If permission check is required but user doesn't have permission, don't render the button
    if (
      permissionModule &&
      permissionAction &&
      !checkPermission(permissionModule, permissionAction)
    ) {
      return null;
    }
