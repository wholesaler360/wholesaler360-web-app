...
function VendorLedgerComponent() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        setIsLoading(true);
        const response = await getLedgerEntries(vendorId);
        if (response.success) {
    ...
    fetchData();
  }, [getLedgerEntries, vendorId, navigate]);
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                View all financial transactions for this vendor.
              </p>
            </div>
          </div>
        </div>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new ledger entry for this vendor.
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
...
export default VendorLedgerComponent;
